...
### [1] [Mobile Communications in Intelligent Rail Transit: From LCX to PASS](https://arxiv.org/abs/2604.12899)
*Yiran Guo,Wei Chen,Cong Yu,Bo Ai,Yuanwei Liu,Michail Matthaiou*

Main category: eess.SP

TL;DR: This paper discusses the development of pinching-antenna systems (PASS) to improve wireless communication in rail transit, addressing challenges posed by existing leaky coaxial cables (LCX).


<details>
  <summary>Details</summary>
Motivation: The need for high-capacity and reliable wireless communication solutions in rail transit systems due to harsh propagation conditions.

Method: The paper proposes pinching-antenna systems (PASS) as waveguide-based architectures with reconfigurable radiation points and evaluates their performance against leaky coaxial cables (LCX) through simulations. A deep learning framework for channel estimation in dynamic conditions is also introduced.

Result: PASS demonstrates superior deployment flexibility and lower overhead compared to LCX, with effective performance in channel estimation under mobility.

Conclusion: The paper highlights practical deployment challenges for PASS and suggests future research directions to overcome these obstacles.
...
### [2] [WiseOWL: A Methodology for Evaluating Ontological Descriptiveness and Semantic Correctness for Ontology Reuse and Ontology Recommendations](https://arxiv.org/abs/2604.12025)
*Aryan Singh Dalal,Maria Baloch,Asiyah Yu Lin,Anna Maria Masci,Kathleen M. Jagodnik,Hande Kucuk McGinty*

Main category: cs.AI

TL;DR: WiseOWL is a methodology that aids in the systematic selection of ontologies for reuse by scoring four metrics and providing actionable feedback through a user-friendly application.


<details>
  <summary>Details</summary>
Motivation: To address the challenges faced in selecting ontologies for reuse due to a lack of systematic criteria, often leading to reliance on intuition.

Method: The WiseOWL methodology scores ontologies on four metrics: Well-Described, Well-Defined, Connection, and Hierarchical Breadth, providing normalized scores and feedback. It is implemented as a Streamlit app for user interaction.

Result: Evaluation of WiseOWL against six ontologies shows promising effectiveness in scoring and providing guidance for ontology selection.

Conclusion: WiseOWL enhances the ontology selection process, facilitating reuse and supporting consistent interpretation in the Semantic Web.
