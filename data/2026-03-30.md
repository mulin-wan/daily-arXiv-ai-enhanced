...
### [1] [Generalizable task-oriented object grasping through LLM-guided ontology and similarity-based planning](https://arxiv.org/abs/2603.26412)
*Hao Chen,Takuya Kiyokawa,Weiwei Wan,Kensuke Harada*

Main category: cs.RO

TL;DR: This paper presents a geometry-centric approach to task-oriented grasping (TOG) that enhances generalization across diverse objects and tasks by using an ontology and geometric analysis instead of relying on vision-based semantic features.


<details>
  <summary>Details</summary>
Motivation: The motivation is to improve the generalizability of task-oriented grasping methods, which are limited by instability in part recognition and grasp inference using vision-language models.

Method: The methodology includes developing an object-part-task ontology via a Large Language Model, a sampling-based geometric analysis for part identification from point clouds, and a similarity matching framework for grasp planning.

Result: The approach achieves high accuracy in part selection, identification, and grasp generation through experimental validation, indicating strong performance in real-world scenarios.

Conclusion: The proposed method successfully generalizes to novel-object categories, showcasing adaptability across various tasks and objects, while effectively bypassing semantic limitations of conventional models.
